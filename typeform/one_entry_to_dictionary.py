def one_entry_to_dictionary(person):
    ...
    d = {"id": person["landing_id"], "gender": 0, "age": 0, "ethnicity": 0, "live_alone": 0,
         "live_friends": 0, "live_partner": 0, "live_parents": 0, "live_siblings": 0, "live_otherfamily": 0,
         "live_children": 0, "live_other": 0, "location": 0, "safety_level": 0, "safety_change": 0, "safety_why": 0,
         "mental_scale": 0, "mental_problems_repetitive": 0, "mental_problems_lonely": 0, "mental_problems_stressed": 0,
         "mental_problems_anxious": 0, "mental_problems_worriedhealth": 0, "mental_problems_scaredfuture": 0,
         "mental_problems_relationship": 0, "mental_problems_other": 0, "mental_problems_none": 0,
         "positive_impact_support_housework": 0, "positive_impact_support_childcare": 0, "positive_impact_connect": 0,
         "positive_impact_leisure": 0, "positive_impact_wfh": 0, "positive_impact_other": 0, "positive_impact_none": 0,
         "work_situation": 0, "financial_situation": 0, "housework_amount": 0, "housework_change": 0, "testimonial": 0,
    ...
    for entry in person["answers"]:
        ...
        # LIST OF POSITIVE IMPACTS
            ...
            if "other" in entry["choice"]:
                ...
                print(person["landing_id"], "has entered in column other_work:", entry["choice"]["other"],
                      "// THIS ENTRY WAS DISCARDED AND SAVED AS OTHER")
